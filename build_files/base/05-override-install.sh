...
# Patched shell
dnf5 -y remove kf6-kio-core kf6-kio-core-libs kf6-kio-doc kf6-kio-file-widgets kf6-kio-gui kf6-kio-widgets
dnf5 -y --repo=terra install kf6-kio

# Make sure KDE Frameworks and our kf6-kio are on the same version
kf6_version=$(rpm -qi kf6-kcoreaddons | awk '/^Version/ {print $3}')
kf6_kio_version=$(rpm -qi kf6-kio.switcheroo | awk '/^Version/ {print $3}')
